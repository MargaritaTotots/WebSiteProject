    ...
    <form:form  action="/sort" method="post">
        ...
        <div class="form-inline" style="padding-bottom: 30px; ">
            ...
            <select name = "fullness" class="form-control" style="width: 160px;">
                <option selected value="Fullness">Fullness</option>
                <c:forEach items="${fullnesses}" var="fullness">
                    <option value = ${fullness}>${fullness}</option>
                </c:forEach>
            </select>

            <select name="costFrom" class="form-control" style="width: 160px;">
                <option selected value="CostFrom">Cost From</option>
                <option value="100">100</option>
                <option value="200">200</option>
                <option value="300">300</option>
            </select>

            <select name="costTo" class="form-control" style="width: 160px;">
                <option selected value="CostTo">Cost To</option>
                <option value="200">200</option>
                <option value="300">300</option>
                <option value="400">400</option>
            </select>
            <div class="form-group"> <!-- Submit button -->
                <button class="btn btn-primary " name="sort" type="submit" style="width: 130px;background-color: black;border-color: black;">Sort</button>
            </div>
        </div>
    </form:form>
                ...
                <c:forEach items="${listCars}" var="car">
                    <div class ="col-6 col-sm-4 col-md-3 p-2">
                        <div class="card h-100" style="max-width: 36rem;  padding-bottom: 50px;">
                            ...
                            <a href="/addCart/${car.id}"><button type="button" class="btn btn-success" style="background-color: black; border-color: black">Add to cart</button></a>
                        </div>
                    </div>
                </c:forEach>
            </c:if>
